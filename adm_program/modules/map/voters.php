...
$lat = $row['lat'];
$lon = $row['lon'];
$title = "Dummystraße 123";
$description .= '<form>Ich war hier und habe:<br /><input type="button" value="Flyer eingeworfen" /><br /><input type="button" value="Gespr&auml;ch gef&uuml;hrt" /></form>';
$icon = "../../../adm_themes/ppoe/icons/house.png";
$w += 2;
$iconSize = "$w,$w";
$o = $w / 2.0;
$iconOffset = "-$o,-$o";
