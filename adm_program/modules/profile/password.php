            ...
            <ul class="formFieldList">';
                ...
                echo'
                    <li>
                        <dl>
                            ...
                            <dd><input type="password" id="old_password" name="old_password" size="12" maxlength="75" />
                ...
                <li>
                    <dl>
                        ...
                        <dd><input type="password" id="new_password" name="new_password" size="12" maxlength="75" />
                ...
                <li>
                    <dl>
                        ...
                        <dd><input type="password" id="new_password2" name="new_password2" size="12" maxlength="75" />
                            <span class="mandatoryFieldMarker" title="'.$gL10n->get('SYS_MANDATORY_FIELD').'">*</span></dd>
                    </dl>
                </li>
            </ul>
